      ...
      <section id="top" className="hero">
        ...
        <div className="hero-visual reveal visible">
          <div className="portrait-wrap">
            <Image
              src="/vanesha-headshot.jpg"
              alt="Professional headshot of Vanesha Hari"
              width={620}
              height={780}
              priority
              className="portrait"
            />
            <div className="portrait-badge">AI × EMBEDDED × SOFTWARE</div>
          </div>
...
Available Jan–Aug 2027`}
      ...
      <section id="contact" className="contact reveal">
        ...
        <div className="contact-actions">
          ...
          <a className="button secondary" href="https://www.linkedin.com/in/vanesha-hari-7119161ab" target="_blank" rel="noreferrer">LinkedIn</a>
          <a className="button secondary" href="https://github.com/vanesha2025S" target="_blank" rel="noreferrer">GitHub</a>
        </div>
      </section>
